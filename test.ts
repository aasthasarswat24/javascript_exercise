...
const filterArray:{ name: string, age?: number }[] = membersArray.filter((member)=>member.age)
...
var [{name:na ,age }]: { name: string, age?: number }[] =membersArray;
console.log(na ,age);

//11. Rename extracted property of object while destructing
const [{name: name1,age:age1},{name:name2, age:age2}]: { name: string, age?: number }[]  = membersArray;
...
var [{name:na, ...remain}]: { name: string, age?: number }[] = newMembers;
...
const [{...obj1}]: { name: string, age?: number }[] = membersArray;
console.log(obj1);
